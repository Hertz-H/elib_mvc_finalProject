...
<h4 class="fw-bold py-3 mb-4">
  <span class="text-muted fw-light">التصنيفات/</span>
 تعديل
</h4>
<!-- Sticky Actions -->
<div class="row">
  <div class="col-12">
    <div class="card">
      <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row">
        <h5 class="card-title mb-sm-0 me-2">تعديل التصنيف</h5>
      ...
      <div class="card-body">
        <div class="row">
          ...
          <form action="/edit_cat" method="post" enctype="multipart/form-data">
          <?php   foreach( $params as $data ){?> 
           
            <div class="row g-3">
              <div class="col-md-6">
                <label class="form-label" for="Title">الاسم</label>
                <input type="text" id="Title" class="form-control" placeholder=""  name="name" value="<?= $data["name"] ?>"/>
              </div>
              <div class="col-md-6">
                <label class="form-label" for="email">الصورة</label>
                <div class="input-group input-group-merge">
                  <input class="form-control" type="file" id=" " name="img"  aria-label="john.doe" aria-describedby="email3" />
