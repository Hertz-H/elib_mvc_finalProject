...
<?php   foreach( $params as $data ){?> 
  <form class="card-body" action="/edit_user" method="POST">

    <div class="row g-3">
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">الاسم</label>
        <input name="name" type="text" id="multicol-username" class="form-control" placeholder="" value="<?=$data["name"]?>" required />
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-email">الايميل</label>
        <div class="input-group input-group-merge">
          <input  name="email"type="text" id="multicol-email" class="form-control" placeholder=" " aria-label="john.doe" aria-describedby="multicol-email2" value="<?=$data["email"]?>"required/>
