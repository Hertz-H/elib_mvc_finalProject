  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row">
        <h5 class="card-title mb-sm-0 me-2">تعديل كتاب</h5>
      ...
      <div class="card-body">
        <div class="row">
          ...
          <?php   foreach( $params[3] as $data ){?> 
          <form action="/save_edit_book" method="post" enctype="multipart/form-data">
         
            <div class="row g-3">
              <div class="col-md-6">
                <label class="form-label" for="Title">الاسم</label>
                <input type="text" id="Title" class="form-control" placeholder=""  name= "name" value="<?= $data["title"] ?>" />
              </div>
              <div class="col-md-6">
                <label class="form-label" for="email">الصورة</label>
                <div class="input-group input-group-merge">
                  <input class="form-control" type="file" id=" " name="book_img" placeholder="john.doe" aria-label="john.doe" aria-describedby="email3"  value="<?= $data["image"] ?>" />
                  <span class="input-group-text" id="email3"> </span>
                </div>
              </div>
              <div class="col-md-6">
                <label class="form-label" for="state">الصنف</label>
                <select id="state" class="select2 form-select" data-allow-clear="true" name="cate_id">
              ...
              <div class="col-md-6">
                ...
                <input type="text" id="alt-num" class="form-control phone-mask" placeholder="" value="<?= $data["price"] ?>" name="price"/>
              </div>
              <div class="col-12">
                <label class="form-label" for="address">الوصف</label>
                <textarea name="description"  class="form-control" id="address" rows="2" placeholder="" value="<?= $data["description"]?>">
                    <?= $data["description"] ?>
                </textarea>
              </div>
              ...
              <div class="col-md-6">
                ...
                <select id="state" class="select2 form-select" data-allow-clear="true" name="author_id">
                <?php foreach($params[1] as $author){?> 
              ...
              <div class="col-md-6">
                ...
                <select id="state" class="select2 form-select" data-allow-clear="true"name="publisher_id">
                <?php foreach($params[2] as $publisher){?> 
              ...
              <div class="col-md-6">
                ...
                <input type="text" id="alt-num" class="form-control phone-mask" placeholder="" value="<?= $data["pages_number"] ?>"name="page_num"/>
              </div>
              <div class="col-md-6">
                <label class="form-label" for="landmark">الصيغة</label>
                <input type="text" id="landmark" class="form-control" placeholder="" value="<?= $data["format"] ?>"name="format"/>
              </div>
             
              <div class="col-md-6">
                <label class="form-label" for="pincode">الكمية</label>
                <input type="text" id="pincode" class="form-control" placeholder="" value="<?= $data["quantity"] ?>"name="quantity"/>
              </div>
