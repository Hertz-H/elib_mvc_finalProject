  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row">
        <h5 class="card-title mb-sm-0 me-2">اضافة عرض</h5>
      ...
      <div class="card-body">
        <div class="row">
          ...
          <!-- <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="offerType" id="inlineRadio2" value="booksIds" />
                    <label class="form-check-label" for="inlineRadio2">حسب الكتاب</label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="offerType" id="inlineRadio2" value="catId" />
                    <label class="form-check-label" for="inlineRadio2">حسب القسم</label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="offerType" id="inlineRadio2" value="option2" />
              ...
              <div class="col-md-6">
                ...
                <select id="state" class="select2 form-select" name="cat[]" data-allow-clear="true" >
                <?php
            ...
            <option value="<?= $cats['id'];?>"><?= $cats['name'] ;?></option>
              ...
              <div class="col-md-6">
                ...
                <select id="state" name="books[]" class="select2 form-select" data-allow-clear="true" multiple>
                <?php
