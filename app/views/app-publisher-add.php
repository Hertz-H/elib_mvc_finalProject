...
<h4 class="fw-bold py-3 mb-4">
  <span class="text-muted fw-light">دار نشر/</span>
 اضافة
</h4>
<!-- Sticky Actions -->
<div class="row">
  <div class="col-12">
    <div class="card">
      <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row">
        <h5 class="card-title mb-sm-0 me-2">اضافة دار نشر </h5>
            ...
            <div class="row g-3">
              ...
              <div class="col-md-6">
                ...
                <div class="input-group input-group-merge">
                  <input class="form-control" type="file" id=" " name="img" placeholder="john.doe" aria-label="john.doe" aria-describedby="email3" />
              ...
              <div class="col-md-6">
                ...
                <input type="text" id="alt-num" class="form-control phone-mask" name="phone_2" placeholder="" />
              </div>
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                ...
                <input type="text" id="alt-num" name="fax"class="form-control phone-mask" placeholder="" />
              </div>
              <div class="col-md-6">
                <label class="form-label" for="alt-num">العنوان</label>
                <input type="text" id="alt-num" class="form-control"name="address" placeholder="" />
              </div>
              <div class="col-md-6">
                <label class="form-label" for="alt-num">الدولة</label>
                <input type="text" id="alt-num" name="country" class="form-control " placeholder="" />
              </div>
