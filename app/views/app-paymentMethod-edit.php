...
<!-- / Navbar -->
  ...
  <span class="text-muted fw-light">طريقة دفع/</span>
 تعديل
</h4>
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row">
        <h5 class="card-title mb-sm-0 me-2">تعديل طريقة دفع </h5>
        
      </div>
      <div class="card-body">
        <div class="row">
          <div class="col-lg-8 mx-auto">
          <form action="/save_paymentMehtod" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-3">
              ...
              <div class="col-md-6">
                ...
                <div class="input-group input-group-merge">
                  <input class="form-control" type="file" id=" " name="img" placeholder=" " aria-label=" " aria-describedby="email3" />
