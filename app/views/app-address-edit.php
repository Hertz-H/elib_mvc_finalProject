...
<svg width="25" viewBox="0 0 25 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <ul class="menu-inner py-1">
      ...
      <ul class="menu-sub">
        <li class="menu-item active">
          <a href="app-user-list.html" class="menu-link">
            <div data-i18n="عرص">عرص </div>
          </a>
        </li>
        <li class="menu-item">
          <a href="app-user-add.html" class="menu-link">
    ...
    <li class="menu-item active ">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        <i class="menu-icon tf-icons bx bx-user"></i>
        <div data-i18n=" التصنيف ">التصنيف</div>
      </a>
      <ul class="menu-sub">
        <li class="menu-item active">
          <a href="app-category-list.html" class="menu-link">
            <div data-i18n="عرض">عرض</div>
          </a>
        </li>
        <li class="menu-item">
    ...
    <li class="menu-item active ">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        <i class="menu-icon tf-icons bx bx-user"></i>
        <div data-i18n=" المؤلفين ">المؤلفين</div>
      </a>
      <ul class="menu-sub">
        <li class="menu-item active">
          <a href="app-author-list.html" class="menu-link">
            <div data-i18n="عرض">عرض</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="app-author-add.html" class="menu-link">
            <div data-i18n="اضافة">اضافة</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="app-author-edit.html" class="menu-link">
            <div data-i18n="تعديل">تعديل</div>
          </a>
        </li>
      </ul>
    ...
    <li class="menu-item active ">
      ...
      <ul class="menu-sub">
        <li class="menu-item active">
          <a href="app-publisher-list.html" class="menu-link">
            <div data-i18n="عرض">عرض</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="app-publisher-add.html" class="menu-link">
            <div data-i18n="اضافة">اضافة</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="app-publisher-edit.html" class="menu-link">
            <div data-i18n="تعديل">تعديل</div>
          </a>
        </li>
      </ul>
    ...
    <li class="menu-item active ">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        <i class="menu-icon tf-icons bx bx-user"></i>
        <div data-i18n=" المدينة ">المدينة</div>
      </a>
      <ul class="menu-sub">
        <li class="menu-item active">
          <a href="app-city-list.html" class="menu-link">
            <div data-i18n="عرض">عرض</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="app-city-add.html" class="menu-link">
            <div data-i18n="اضافة">اضافة</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="app-city-edit.html" class="menu-link">
            <div data-i18n="تعديل">تعديل</div>
          </a>
        </li>
      </ul>
    ...
    <li class="menu-item active ">
      ...
      <ul class="menu-sub">
        <li class="menu-item active">
          <a href="app-offer-list.html" class="menu-link">
            <div data-i18n="عرض">عرض</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="app-offer-add.html" class="menu-link">
            <div data-i18n="اضافة">اضافة</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="app-offer-edit.html" class="menu-link">
            <div data-i18n="تعديل">تعديل</div>
          </a>
        </li>
      </ul>
    ...
    <li class="menu-item active ">
      ...
      <ul class="menu-sub">
        <li class="menu-item active">
          <a href="app-order-list.html" class="menu-link">
            <div data-i18n="عرض">عرض</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="app-order-add.html" class="menu-link">
            <div data-i18n="اضافة">اضافة</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="app-order-edit.html" class="menu-link">
            <div data-i18n="تعديل">تعديل</div>
          </a>
        </li>
      </ul>
    ...
    <li class="menu-item active ">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        <i class="menu-icon tf-icons bx bx-user"></i>
        <div data-i18n=" طرق الدفع ">'طرق الدفع'</div>
      </a>
      <ul class="menu-sub">
        <li class="menu-item active">
          <a href="app-paymentMethod-list.html" class="menu-link">
            <div data-i18n="عرض">عرض</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="app-paymentMethod-add.html" class="menu-link">
            <div data-i18n="اضافة">اضافة</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="app-paymentMethod-edit.html" class="menu-link">
            <div data-i18n="تعديل">تعديل</div>
          </a>
        </li>
      </ul>
    ...
    <li class="menu-item active ">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        <i class="menu-icon tf-icons bx bx-user"></i>
        <div data-i18n=" العناويين ">العناويين</div>
      </a>
      <ul class="menu-sub">
        <li class="menu-item active">
          <a href="app-address-list.html" class="menu-link">
            <div data-i18n="عرض">عرض</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="app-address-add.html" class="menu-link">
            <div data-i18n="اضافة">اضافة</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="app-address-edit.html" class="menu-link">
            <div data-i18n="تعديل">تعديل</div>
          </a>
        </li>
      </ul>
...
<h4 class="fw-bold py-3 mb-4">
  <span class="text-muted fw-light">العناويين</span>
  تعديل
</h4>
<!-- Sticky Actions -->
<div class="row">
  <div class="col-12">
    <div class="card">
      <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row">
        <h5 class="card-title mb-sm-0 me-2">تعديل العنوان</h5>
          ...
          <div class="col-lg-8 mx-auto">
            <form action="" method="post" >
              ...
              <div class="row g-3">
                ...
                <div class="col-md-6">
                  <label class="form-label" for="alt-num">المستخدم</label>
