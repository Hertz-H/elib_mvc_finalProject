...
<?php foreach ( $params[0] as $data){?>
        <tr style="height:150px;">  
          ...
          <td><ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
            <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" class="avatar avatar-xs pull-up" title="Lilian Fuller" style="width:80px;height:80px">
             <img src="images/<?= $data['image'];?>" alt="Avatar" class="rounded" style="width:80px;height:80px">
         ...
         <td>
          ...
          <td> 
            <a class="edit" href="/edit_book" data-id="<?= $data["id"] ?>" id="edit"><i class="bx bx-edit-alt me-1"></i> </a>
            <?php if($data['is_active']==1) {?>   
            <a class="edit" href="/activate" data-id="<?= $data["id"] ?>" id="0">
                <i class="tf-icons bx bx-trash me-1 " style="color:red"></i>
              </a>
              <?php }
            else {?>
                <a class="edit" href="/activate" data-id="<?= $data["id"] ?>"  id="1">
