...
<h4 class="fw-bold py-3 mb-4">
  <span class="text-muted fw-light">طرق دفع المستخدم/</span>
 اضافة
</h4>
<!-- Sticky Actions -->
<div class="row">
  <div class="col-12">
    <div class="card">
      <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row">
        <h5 class="card-title mb-sm-0 me-2">اضافة طريفة دفع</h5>
       
      </div>
      <div class="card-body">
        <div class="row">
          <div class="col-lg-8 mx-auto">
          <form action="/save_userPayMethod" method="POST" >
            ...
            <div class="col-md-6">
              ...
              <div class="col-md-6">
                ...
                <select id="payment_id" class="select2 form-select" data-allow-clear="true">
