...
<h4 class="fw-bold py-3 mb-4">
  <span class="text-muted fw-light">المدن/</span>
 تعديل
</h4>
<!-- Sticky Actions -->
<div class="row">
  <div class="col-12">
    <div class="card">
      <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row">
        <h5 class="card-title mb-sm-0 me-2">تعديل المدينة</h5>
          ...
          <form action="/edit_city" method="post" >
            ...
            <div class="row g-3">
              <div class="col-md-6">
                ...
                <input type="text" name="name" id="Title" class="form-control" placeholder="" value="<?= $data['name'];?> " />
              </div>
