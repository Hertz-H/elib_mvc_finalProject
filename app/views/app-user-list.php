...
<?php foreach ( $params[0] as $data){?>
        <tr >  
         ...
         <td>
            ...
            <td> 
            <a class="edit" href="/edit_user" data-id="<?= $data["id"] ?>" id="edit"><i class="bx bx-edit-alt me-1"></i> </a>
            <?php if($data['is_active']==1) {?>   
            <a class="edit" href="/activate_user" data-id="<?= $data["id"] ?>" id="0">
                <i class="tf-icons bx bx-trash me-1 " style="color:red"></i>
              </a>
              <?php }
            else {?>
                <a class="edit" href="/activate_user" data-id="<?= $data["id"] ?>"  id="1">
