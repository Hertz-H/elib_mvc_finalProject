...
<svg width="25" viewBox="0 0 25 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item  ">
      ...
      <ul class="menu-sub">
        <li class="menu-item ">
          <a href="list_cat" class="menu-link">
            <div data-i18n="عرض">عرض</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="add_cat" class="menu-link">
            <div data-i18n="اضافة">اضافة</div>
          </a>
        </li>
    ...
    <li class="menu-item  ">
      ...
      <ul class="menu-sub">
        <li class="menu-item ">
          <a href="/list_author" class="menu-link">
            <div data-i18n="عرض">عرض</div>
          </a>
        </li>
        <li class="menu-item">
    ...
    <li class="menu-item  ">
      ...
      <ul class="menu-sub">
        <li class="menu-item ">
          <a href="/list_publishers" class="menu-link">
            <div data-i18n="عرض">عرض</div>
          </a>
        </li>
        <li class="menu-item">
     ...
     <li class="menu-item  ">
      ...
      <ul class="menu-sub">
        <li class="menu-item ">
          <a href="list_order" class="menu-link">
            <div data-i18n="عرض">عرض</div>
          </a>
        </li>
        <li class="menu-item">
    ...
    <!-- <li class="menu-item  ">
      ...
      <ul class="menu-sub">
        <li class="menu-item ">
          <a href="list_address" class="menu-link">
            <div data-i18n="عرض">عرض</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="add_address" class="menu-link">
            <div data-i18n="اضافة">اضافة</div>
          </a>
        </li>
